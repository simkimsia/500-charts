    ...
    var Color = (function () {
        ...
        */
        Color.prototype.toString = function () {
            return this.a > 0.99 ? '#' + this._toHex(this.r) + this._toHex(this.g) + this._toHex(this.b) : wijmo.format('rgba({r},{g},{b},{a:g2})', this);
        };
        Color.prototype._toHex = function (n) {
            var t = n.toString(16);
